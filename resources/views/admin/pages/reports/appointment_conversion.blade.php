        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small mb-0">
                    {{ __('Track booking conversion rates (confirmed to completed), checkout revenue, cancellation and no-show performance.') }}
                </p>
            </div>
            <div>
                ...
                <div class="row g-3 align-items-end">
                    <div class="col-md-3">
                        <label for="filter_branch_id"
                            class="form-label small fw-bold text-secondary">{{ __('Branch') }}</label>
                        <select id="filter_branch_id" class="form-select form-select-sm" {{ !($canSelectAll ?? true) ? 'disabled' : '' }}>
                            @if($canSelectAll ?? true)
                                <option value="all" {{ ($effectiveBranchId ?? null) === null ? 'selected' : '' }}>
                                    {{ __('All Branches') }}</option>
                            @endif
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" id="from_date" class="form-control form-control-sm"
                            value="{{ $fromDate ?? now()->startOfMonth()->toDateString() }}">
                    </div>
                ...
                <div class="card kpi-card shadow-sm h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted"><span id="stat-completed-ratio">0</span>
                                {{ __('completed of confirmed') }}</small>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card shadow-sm h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted"><span id="stat-confirmed-count">0</span>
                                {{ __('confirmed / active') }}</small>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card shadow-sm h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="kpi-value text-dark" id="stat-invoiced-revenue">__('$') 0.00</div>
                            <small class="text-muted"><span id="stat-invoiced-count">0</span>
                                {{ __('appointments checked out') }}</small>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card shadow-sm h-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted"><span id="stat-cancelled-count">0</span> {{ __('cancelled') }} / <span
                                    id="stat-noshow-count">0</span> {{ __('no-show') }}</small>
                        </div>
                    </div>
                </div>
            </div>
