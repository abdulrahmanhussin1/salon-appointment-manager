...
class ProductFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'category_id' => $this->faker->optional()->numberBetween(1, 3),  // Assuming categories 1 to 10 exist
            'supplier_id' => $this->faker->optional()->numberBetween(1, 3),  // Assuming suppliers 1 to 10 exist
